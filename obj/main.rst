...
Hexadecimal [16-Bits]
                             ...
                             17 ;;-------------------------------------------------------------------------------
                             18 
                             19 .globl sys_system_enable_firmware
                             20 .globl sys_system_disable_firmware
...
Hexadecimal [16-Bits]
                             ...
                             24 ;;.include "sys/board.h.s"
                             25 ;;.include "sys/input.h.s"
                             26 ;;.include "sys/text.h.s"
                             27 ;;.include "sys/messages.h.s"
                             28 ;;.include "man/entity.h.s"
                             29 ;;.include "man/game.h.s"
                             30 ;;.include "sys/audio.h.s"
                             31 ;;.include "sys/score.h.s"
                             32 ;;.include "sys/files.h.s"
                             33 
                             34 .module main
                             35 
                             36 ;;-----------------------------------------------------------------
                             37 ;;
                             38 ;; Start of _DATA area 
                             39 ;;  SDCC requires at least _DATA and _CODE areas to be declared, but you may use
                             40 ;;  any one of them for any purpose. Usually, compiler puts _DATA area contents
                             41 ;;  right after _CODE area contents.
                             42 ;;
                             43 .area _DATA
                             44 
                             45 ;;
                             46 ;; Start of _CODE area
                             47 ;; 
                             48 .area _CODE
                             49 
                             50 
                             ...
                             55 ;;  Input:  
                             56 ;;  Output: 
                             57 ;;  Destroyed: af, bc,de, hl
                             58 ;;
   448B                      59 _main_init::
                             60 
                             61 ;;   call sys_audio_init
                             62 ;;
                             63 ;;   call sys_render_init
                             64 
                             65    ;; set random seed
   448B AF            [ 4]   66    xor a
   448C F5            [11]   67    push af                             ;; store a=0 in the stack
   448D                      68 _main_init_keypress:
   448D F1            [10]   69    pop af                              ;; retrive a value form stack
   448E 3C            [ 4]   70    inc a                               ;; inc a value
   448F F5            [11]   71    push af                             ;; store a value in stack
                             72    
   4490 23            [ 6]   73    inc hl
   4491 CD CD 47      [17]   74    call cpct_isAnyKeyPressed_asm
   4494 B7            [ 4]   75    or a
   4495 28 F6         [12]   76    jr z, _main_init_keypress
                             77 
...
Hexadecimal [16-Bits]
   ...
   4497 21 00 BC      [10]   78    ld hl, #0xbc00
   449A 11 00 AC      [10]   79    ld de, #0xac00
   449D F1            [10]   80    pop af                              ;; retrieve last a value to set the seed
   449E CD 9D 47      [17]   81    call cpct_setSeed_xsp40_u8_asm      ;; change seed
                             82 
   0016                      83    cpctm_clearScreen_asm 255
   44A1 21 00 C0      [10]    1    ld    hl, #0xC000    ;; [3] HL Points to Start of Video Memory
   44A4 11 01 C0      [10]    2    ld    de, #0xC001    ;; [3] DE Points to the next byte
   44A7 01 00 40      [10]    3    ld    bc, #0x4000    ;; [3] BC = 16384 bytes to be copied
   44AA 36 FF         [10]    4    ld   (hl), #255      ;; [3] First Byte = given Colour
   44AC ED B0         [21]    5    ldir                 ;; [98297] Perform the copy
                             84    
                             85    ;;call sys_input_init
                             86 
   44AE C9            [10]   87    ret
                             88 ;;-----------------------------------------------------------------
                             89 ;;
                             90 ;; MAIN function. This is the entry point of the application.
                             91 ;;    _main:: global symbol is required for correctly compiling and linking
                             92 ;;
   44AF                      93 _main::
                             94 
   44AF CD 6A 46      [17]   95    call sys_system_disable_firmware
                             96 
   44B2 CD 8B 44      [17]   97    call _main_init
                             98 
   44B5                      99 start:
                            100 ;;   call man_game_init
                            101 
                            102    ;; Loop forever
   44B5                     103 loop:
                            104 ;;   call man_game_update
                            105 
   44B5 18 FE         [12]  106    jr    loop
