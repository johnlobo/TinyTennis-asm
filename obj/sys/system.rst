...
Hexadecimal [16-Bits]
                             ...
                             23 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             24 ;;DESCRIPTION
                             25 ;; Called every interruption
                             26 ;;
                             27 ;;DESTROYS: AF, BC, DE
                             28 ;;
   460A                      29 set_int_handler:
   460A 21 38 00      [10]   30 	ld hl, #0x38
   460D 36 C3         [10]   31 	ld (hl), #0xc3
   460F 23            [ 6]   32 	inc hl
   4610 36 19         [10]   33 	ld (hl), #<int_handler1
   4612 23            [ 6]   34 	inc hl
   4613 36 46         [10]   35 	ld (hl), #>int_handler1
   4615 23            [ 6]   36 	inc hl
   4616 36 C9         [10]   37 	ld (hl), #0xc9
   4618 C9            [10]   38 	ret
                             39 
                             40 
                             41 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             42 ;;DESCRIPTION
                             43 ;; Called on the first interruption
                             44 ;;
                             45 ;;DESTROYS: AF, BC, DE
                             46 ;;
   4619                      47 int_handler1::
   4619 21 20 46      [10]   48 	ld hl, #int_handler2
   461C CD 7C 46      [17]   49  	call cpct_setInterruptHandler_asm	
   461F C9            [10]   50 	ret
                             51 
                             52 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             53 ;;DESCRIPTION
                             54 ;; Called every interruption
                             55 ;;
                             56 ;;DESTROYS: AF, BC, DE
                             57 ;;
   4620                      58 int_handler2::
   4620 CD DA 47      [17]   59 	call cpct_scanKeyboard_if_asm
                             60 
                             61 
   4623 21 2A 46      [10]   62 	ld hl, #int_handler3
   4626 CD 7C 46      [17]   63    call cpct_setInterruptHandler_asm
   4629 C9            [10]   64 	ret
                             65 
                             66 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             67 ;;DESCRIPTION
                             68 ;; Called every interruption
                             69 ;;
                             70 ;;DESTROYS: AF, BC, DE
                             71 ;;
   462A                      72 int_handler3::
   462A 21 31 46      [10]   73 	ld hl, #int_handler4
   462D CD 7C 46      [17]   74    call cpct_setInterruptHandler_asm
   4630 C9            [10]   75 	ret
                             76 
...
Hexadecimal [16-Bits]
                             ...
                             77 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             78 ;;DESCRIPTION
                             79 ;; Called every interruption
                             80 ;;
                             81 ;;DESTROYS: AF, BC, DE
                             82 ;;
   4631                      83 int_handler4::	
   4631 21 38 46      [10]   84 	ld hl, #int_handler5
   4634 CD 7C 46      [17]   85    call cpct_setInterruptHandler_asm
   4637 C9            [10]   86 	ret
                             87 
                             88 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             89 ;;DESCRIPTION
                             90 ;; Called every interruption
                             91 ;;
                             92 ;;DESTROYS: AF, BC, DE
                             93 ;;
   4638                      94 int_handler5::
                             95 ;;  ld a, (music_switch)
                             96 ;;  or a
                             97 ;;  jr z, int_handler5_exit
                             98 ;;  exx
                             99 ;;  ex af', af  
                            100 ;;  push af
                            101 ;;  push bc
                            ...
                            109 ;;  ex af', af  
                            110 ;;  exx
   4638                     111 int_handler5_exit:
   4638 21 3F 46      [10]  112 	ld hl, #int_handler6
   463B CD 7C 46      [17]  113    call cpct_setInterruptHandler_asm
   463E C9            [10]  114 	ret
                            115 
                            116 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            117 ;;DESCRIPTION
                            118 ;; Called every interruption
                            119 ;;
                            120 ;;DESTROYS: AF, BC, DE
                            121 ;;
   463F                     122 int_handler6::
   463F 21 19 46      [10]  123 	ld hl, #int_handler1
   4642 CD 7C 46      [17]  124    call cpct_setInterruptHandler_asm
   4645 C9            [10]  125 	ret
                            126 
                            127 ;;-----------------------------------------------------------------
                            128 ;;
                            129 ;; sys_system_enable_firmware
                            130 ;; Disable firmware
                            131 ;;  Input:  
...
Hexadecimal [16-Bits]
                            ...
                            132 ;;  Output: 
                            133 ;;  Destroyed: af, bc,de, hl
                            134 ;;
   4646                     135 sys_system_enable_firmware::        
   4646 F3            [ 4]  136     DI   
                            137 ;;    LD SP,#0xC000     ; On remet la pile a sa valeur initiale
                            138 ;      IM 1             ; on restaure le mode d'interruption standard (pas utile
                            139                         ; la plupart du temps... ).    
   4647 D9            [ 4]  140     EXX                 ; On preserve les registre normaux
   4648 01 88 7F      [10]  141     LD BC,#0x7F88       ;connexion sur ROM inferieure
   464B ED 49         [12]  142     OUT (C),C
   464D D9            [ 4]  143     EXX
   464E AF            [ 4]  144     XOR A               ; utile ?
   464F 08            [ 4]  145     EX AF,AF' 
   4650 CD 44 00      [17]  146     CALL #0x0044        ; Restore 'High Kernel jump' 
                            147                         ; Init zones ram &0 a &3f, &B900 a &BAE4
   4653 CD BD 08      [17]  148     CALL #0x08BD        ; Restore 'Main Jump adress'
                            149                         ; Init zone ram &BB00 a ?
                            150     ;;CALL #0x1B5C      ; Init gestion clavier
                            151     ;;CALL #0x1074      ; Init du 'pack' texte
   4656 D9            [ 4]  152     EXX  
   4657 01 8C 7F      [10]  153     LD BC,#0x7F8C       ; On deconnecte la rom inferieure
   465A ED 49         [12]  154     OUT (C),C           ; et on se met accessoirement en mode 0
   465C D9            [ 4]  155     EXX
   465D FB            [ 4]  156     EI                  ; hop, on n'oublie pas de remettre les interruptions
   465E 21 FF AB      [10]  157     LD HL,#0xABFF       ; Init classique du systeme disque
   4661 11 40 00      [10]  158     LD DE,#0x0040       ; via le vecteur Amsdos regenere !
   4664 0E 07         [ 7]  159     LD C,#0x07
   4666 CD CE BC      [17]  160     CALL #0xBCCE
   4669 C9            [10]  161     ret
                            162 
                            163 ;;-----------------------------------------------------------------
                            164 ;;
                            165 ;; sys_system_disable_firmware
                            166 ;; Disable firmware
                            167 ;;  Input:  
                            168 ;;  Output: 
                            169 ;;  Destroyed: af, bc,de, hl
                            170 ;;
   466A                     171 sys_system_disable_firmware::
   466A CD 5F 48      [17]  172    call cpct_disableFirmware_asm
   466D 21 19 46      [10]  173    ld hl, #int_handler1
   4670 CD 4F 48      [17]  174    call cpct_waitVSYNC_asm
   4673 76            [ 4]  175    halt
   4674 76            [ 4]  176    halt
   4675 CD 4F 48      [17]  177    call cpct_waitVSYNC_asm
   4678 CD 7C 46      [17]  178    call cpct_setInterruptHandler_asm
   467B C9            [10]  179    ret
                            180 
                            181 
