...
Hexadecimal [16-Bits]
                             ...
                             22 
   0000                      23 DefineComponentArrayStructure_Size _entity, MAX_ENTITIES, ENTITY_SIZE     
   44B7 00                    1       _entity_num::     .db 0
   44B8 BA 44                 2       _entity_pend::    .dw _entity_array 
   44BA                       3       _entity_array::
   44BA                       4             .ds MAX_ENTITIES * ENTITY_SIZE
   4596 00                   24 .db 0   ;;ponemos este aqui como trampita para que siempre haya un tipo invalido al final
                             25 
                             26 ;;
                             27 ;; Definition of model deck
                             28 ;;
   4597                      29 model_entity:
                             30 ;;         _status,             _class  _sprite     _name   _rarity _type   _energy _description,       _damage _block, _vulnerable _weak   _strengh    _exhaust    _add_card
   00E0                      31 DefineEntity e_type_card_in_hand, 1,      0x0000, STRIKE, 1,      1,      1,      ^/SINGLE ATTACK/,   3,      0,      0,          0,      0,          0,          0
   4597 01                    1     .db e_type_card_in_hand
   4598 01                    2     .db 1
   4599 00                    3     .db 0x0000
   459A 53 54 52 49 4B 45     4     .asciz "STRIKE"
        00
   45A1 01                    5     .db 1
   45A2 01                    6     .db 1
   45A3 01                    7     .db 1
   45A4 53 49 4E 47 4C 45     8     .asciz "SINGLE ATTACK"
        20 41 54 54 41 43
        4B 00
   45B2 03                    9     .db 3
   45B3 00                   10     .db 0
   ...
   45B7 00                   14     .db 0
   45B8 00                   15     .db 0
   0102                      32 DefineEntity e_type_card_in_hand, 2,      0x0000, DEFEND, 1,      1,      1,      ^/SIMPLE DEFENCE/,  0,      3,      0,          0,      0,          0,          0
   45B9 01                    1     .db e_type_card_in_hand
   45BA 02                    2     .db 2
   45BB 00                    3     .db 0x0000
   45BC 44 45 46 45 4E 44     4     .asciz "DEFEND"
        00
   45C3 01                    5     .db 1
   45C4 01                    6     .db 1
   45C5 01                    7     .db 1
   45C6 53 49 4D 50 4C 45     8     .asciz "SIMPLE DEFENCE"
        20 44 45 46 45 4E
        43 45 00
   45D5 00                    9     .db 0
   45D6 03                   10     .db 3
...
Hexadecimal [16-Bits]
                             ...
                             37 ;; man_entity_init
                             38 ;;
                             39 ;;   gets a random number between 0 and 18
                             40 ;;  Input: 
                             41 ;;  Output: a random piece
                             42 ;;  Modified: AF, BC, DE, HL
                             43 ;;
   45DC                      44 man_entity_init::
   45DC AF            [ 4]   45     xor a
   45DD 32 B7 44      [13]   46     ld  (_entity_num), a
                             47 
   45E0 21 BA 44      [10]   48     ld  hl, #_entity_array      ;;ponemos el puntero de la ultima entidad a la primera posicion del array
   45E3 22 B8 44      [16]   49     ld  (_entity_pend), hl
                             50 
   45E6 36 00         [10]   51     ld  (hl), #e_type_invalid   ;;ponemos el primer elemento del array con tipo invalido
   45E8 C9            [10]   52 ret
                             53 
                             54 
                             55 ;;-----------------------------------------------------------------
                             56 ;;
                             57 ;; man_entity_getArrayHL
                             58 ;;
                             59 ;;   gets a random number between 0 and 18
                             60 ;;  Input: 
                             61 ;;  Output: a random piece
                             62 ;;  Modified: AF, BC, DE, HL
                             63 ;;
   45E9                      64 man_entity_getArrayHL::
   45E9 21 BA 44      [10]   65     ld  hl, #_entity_array
   45EC C9            [10]   66 ret
                             67 
                             68 ;;-----------------------------------------------------------------
                             69 ;;
                             70 ;; man_entity_create_card
                             71 ;;
                             72 ;;   gets a random number between 0 and 18
                             73 ;;  Input: HL: puntero al array con los datos de inicializacion
                             74 ;;  Output: a random piece
                             75 ;;  Modified: AF, BC, DE, HL
                             76 ;;
   45ED                      77 man_entity_create::
                             78 
   45ED ED 5B B8 44   [20]   79     ld  de, (_entity_pend)
   45F1 01 16 00      [10]   80     ld  bc, #ENTITY_SIZE
   45F4 ED B0         [21]   81     ldir
                             82 
                             83     ;;PASAMOS A LA SIGUIENTE ENTIDAD
   45F6 3A B7 44      [13]   84     ld  a, (_entity_num)    ;;aumentamos el numero de entidades
   45F9 3C            [ 4]   85     inc a
   45FA 32 B7 44      [13]   86     ld  (_entity_num), a
                             87 
   45FD 2A B8 44      [16]   88     ld   hl, (_entity_pend) ;;pasamos el puntero a la siguiente entidad
   4600 01 16 00      [10]   89     ld   bc, #ENTITY_SIZE
   4603 09            [11]   90     add  hl, bc
   4604 22 B8 44      [16]   91     ld   (_entity_pend), hl
